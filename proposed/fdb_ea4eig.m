...
%
% Algorithm Concept:
%   - Fitness-Distance Balance extension of EA4eig
...
%   - In the jSO mutation operator, the random p-best guide is replaced
%     with an FDB-selected p-best guide that balances high fitness and
%     distance from the current p-best leader
...
% ----------------------------------------------------------------------- %
function [best_fitness, best_solution, curve, population_history, fitness_history] = fdb_ea4eig(problem)
            ...
            case 4
                ...
                if rand < peig
                    ...
                    for i = 1:N
                        ...
                        pbest = pom(1:p, 1:dim);
                        pbest_fitness = pom(1:p, dim + 1);
                        xpbest = pbest(fitnessDistanceBalance(pbest, pbest_fitness), :);
