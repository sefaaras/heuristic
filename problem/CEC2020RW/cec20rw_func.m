function [f,g,h] = cec20rw_func(x,prob_k)
...
[ps,D]=size(x);
persistent G B P Q L initial_flags
...
if(prob_k == 34)
    ...
    if isempty(initial_flags) || length(initial_flags) < prob_k || initial_flags(prob_k) ~= 1
