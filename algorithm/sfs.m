...
%
% Algorithm Concept:
%   - Based on random fractal search method
%   - Uses diffusion process to generate new points
%   - Two updating processes for exploitation and exploration
%   - Gaussian walks for generating new candidate solutions
%   - Probability-based update mechanism
%
% Reference:
% Salimi, H. (2015),
